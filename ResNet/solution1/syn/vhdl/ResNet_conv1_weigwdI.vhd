...
entity ResNet_conv1_weigwdI_rom is 
    generic(
             DWIDTH     : integer := 1; 
             AWIDTH     : integer := 10; 
...
architecture rtl of ResNet_conv1_weigwdI_rom is 
...
entity ResNet_conv1_weigwdI is
    generic (
        DataWidth : INTEGER := 1;
...
architecture arch of ResNet_conv1_weigwdI is
    component ResNet_conv1_weigwdI_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    ResNet_conv1_weigwdI_rom_U :  component ResNet_conv1_weigwdI_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
