...
// ==============================================================
#ifndef __ResNet_conv1_weigwdI_H__
#define __ResNet_conv1_weigwdI_H__
...
struct ResNet_conv1_weigwdI_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(ResNet_conv1_weigwdI_ram) {
...
SC_MODULE(ResNet_conv1_weigwdI) {
...
ResNet_conv1_weigwdI_ram* meminst;


SC_CTOR(ResNet_conv1_weigwdI) {
meminst = new ResNet_conv1_weigwdI_ram("ResNet_conv1_weigwdI_ram");
