...
// ==============================================================
#ifndef __compute_engine_64eOg_H__
#define __compute_engine_64eOg_H__
...
struct compute_engine_64eOg_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(compute_engine_64eOg_ram) {
        ram[0] = "0b000";
        ram[1] = "0b001";
        ram[2] = "0b001";
        ram[3] = "0b010";
...
SC_MODULE(compute_engine_64eOg) {
...
compute_engine_64eOg_ram* meminst;


SC_CTOR(compute_engine_64eOg) {
meminst = new compute_engine_64eOg_ram("compute_engine_64eOg_ram");
