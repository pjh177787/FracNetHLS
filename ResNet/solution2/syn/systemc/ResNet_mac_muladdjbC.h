...
// ==============================================================
#ifndef __ResNet_mac_muladdjbC__HH__
#define __ResNet_mac_muladdjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ResNet_mac_muladdjbC) {
    ...
    SC_CTOR(ResNet_mac_muladdjbC):  simcore_mac_0_U ("simcore_mac_0_U") {
