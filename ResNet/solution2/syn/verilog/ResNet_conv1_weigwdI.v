...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module ResNet_conv1_weigwdI_rom (
...
initial begin
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram0);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram1);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram2);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram3);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram4);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram5);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram6);
    $readmemh("./ResNet_conv1_weigwdI_rom.dat", ram7);
end
...
ResNet_conv1_weigwdI_rom ResNet_conv1_weigwdI_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
