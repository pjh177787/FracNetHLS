...
set C_modelArgList {
	{ norm_V int 12 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "norm_V", "interface" : "wire", "bitwidth" : 12, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ norm_V sc_in sc_lv 12 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "norm_V", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "norm_V", "role": "default" }} , 
...
set Spec2ImplPortList { 
	norm_V { ap_none {  { norm_V in_data 0 12 } } }
}
