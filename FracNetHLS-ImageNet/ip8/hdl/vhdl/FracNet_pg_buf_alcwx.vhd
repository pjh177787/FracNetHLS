...
entity FracNet_pg_buf_alcwx_ram is 
    generic(
...
architecture rtl of FracNet_pg_buf_alcwx_ram is 
...
entity FracNet_pg_buf_alcwx is
    generic (
...
architecture arch of FracNet_pg_buf_alcwx is
    component FracNet_pg_buf_alcwx_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    FracNet_pg_buf_alcwx_ram_U :  component FracNet_pg_buf_alcwx_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
