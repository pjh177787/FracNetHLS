...
// ==============================================================
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module compute_engine_64lbW_rom (
...
initial begin
    $readmemh("./compute_engine_64lbW_rom.dat", ram0);
    $readmemh("./compute_engine_64lbW_rom.dat", ram1);
    $readmemh("./compute_engine_64lbW_rom.dat", ram2);
    $readmemh("./compute_engine_64lbW_rom.dat", ram3);
    $readmemh("./compute_engine_64lbW_rom.dat", ram4);
    $readmemh("./compute_engine_64lbW_rom.dat", ram5);
    $readmemh("./compute_engine_64lbW_rom.dat", ram6);
    $readmemh("./compute_engine_64lbW_rom.dat", ram7);
end
...
compute_engine_64lbW_rom compute_engine_64lbW_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
