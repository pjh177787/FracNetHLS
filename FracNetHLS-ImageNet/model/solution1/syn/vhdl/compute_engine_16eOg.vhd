...
entity compute_engine_16eOg_rom is 
    generic(
             DWIDTH     : integer := 3; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of compute_engine_16eOg_rom is 
...
entity compute_engine_16eOg is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of compute_engine_16eOg is
    component compute_engine_16eOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_engine_16eOg_rom_U :  component compute_engine_16eOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
