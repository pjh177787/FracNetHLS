...
// ==============================================================
#ifndef __FracNet_mac_muladg8j__HH__
#define __FracNet_mac_muladg8j__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladg8j) {
    ...
    SC_CTOR(FracNet_mac_muladg8j):  simcore_mac_2_U ("simcore_mac_2_U") {
