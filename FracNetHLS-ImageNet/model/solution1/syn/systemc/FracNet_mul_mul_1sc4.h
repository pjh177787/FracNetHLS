...
// ==============================================================
#ifndef __FracNet_mul_mul_1sc4__HH__
#define __FracNet_mul_mul_1sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1sc4) {
    ...
    SC_CTOR(FracNet_mul_mul_1sc4):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
