...
// ==============================================================
#ifndef __FracNet_mac_muladmb6__HH__
#define __FracNet_mac_muladmb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladmb6) {
    ...
    SC_CTOR(FracNet_mac_muladmb6):  simcore_mac_5_U ("simcore_mac_5_U") {
