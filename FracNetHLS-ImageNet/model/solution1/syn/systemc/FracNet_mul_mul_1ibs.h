...
// ==============================================================
#ifndef __FracNet_mul_mul_1ibs__HH__
#define __FracNet_mul_mul_1ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1ibs) {
    ...
    SC_CTOR(FracNet_mul_mul_1ibs):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
