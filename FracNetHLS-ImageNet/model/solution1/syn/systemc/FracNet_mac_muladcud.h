...
// ==============================================================
#ifndef __FracNet_mac_muladcud__HH__
#define __FracNet_mac_muladcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladcud) {
    ...
    SC_CTOR(FracNet_mac_muladcud):  simcore_mac_0_U ("simcore_mac_0_U") {
