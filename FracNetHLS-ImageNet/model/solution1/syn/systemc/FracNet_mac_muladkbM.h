...
// ==============================================================
#ifndef __FracNet_mac_muladkbM__HH__
#define __FracNet_mac_muladkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladkbM) {
    ...
    SC_CTOR(FracNet_mac_muladkbM):  simcore_mac_4_U ("simcore_mac_4_U") {
