...
set IPName      "FracNet"
set Version     "1.0"
set DisplayName "Fracnet"
set Revision    "2009140635"
...
set sdx_kernel_name "FracNet"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/Aperture/Git/ReActNetHLS_test_64_boo/model/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {FracNet_urem_7ns_bkb
...
FracNet_fadd_32nsgxb
FracNet_mux_104_3gyb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 image_thermo_V W 0x0 "Data signal of image_thermo_V" {{0 32 image_thermo_V W 0 "Bit 31 to 0 Data signal of image_thermo_V"}}} {0x18 conv_weight_1x1_all_V W 0x0 "Data signal of conv_weight_1x1_all_V" {{0 32 conv_weight_1x1_all_V W 0 "Bit 31 to 0 Data signal of conv_weight_1x1_all_V"}}} {0x20 conv_weight_3x3_all_V W 0x0 "Data signal of conv_weight_3x3_all_V" {{0 32 conv_weight_3x3_all_V W 0 "Bit 31 to 0 Data signal of conv_weight_3x3_all_V"}}} {0x28 weights_all_V W 0x0 "Data signal of weights_all_V" {{0 32 weights_all_V W 0 "Bit 31 to 0 Data signal of weights_all_V"}}} {0x30 linear_weight_all_V W 0x0 "Data signal of linear_weight_all_V" {{0 32 linear_weight_all_V W 0 "Bit 31 to 0 Data signal of linear_weight_all_V"}}} {0x38 linear_bias_all_V W 0x0 "Data signal of linear_bias_all_V" {{0 32 linear_bias_all_V W 0 "Bit 31 to 0 Data signal of linear_bias_all_V"}}} {0x40 DDR_buff_merge_V W 0x0 "Data signal of DDR_buff_merge_V" {{0 32 DDR_buff_merge_V W 0 "Bit 31 to 0 Data signal of DDR_buff_merge_V"}}} {0x48 out_r W 0x0 "Data signal of out_r" {{0 32 out_r W 0 "Bit 31 to 0 Data signal of out_r"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_IMG m_axi_BUS512 m_axi_DDR512 m_axi_BUS32"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_DDR512 {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_DDR512"
        data_width "512"
        param_prefix "C_M_AXI_DDR512"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 512 WSTRB 64 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 512 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 3 machine 64 combinational 0 latency 3686202 II x}
