...
// ==============================================================
#ifndef __FracNet_mul_mul_1ocq__HH__
#define __FracNet_mul_mul_1ocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1ocq) {
    ...
    SC_CTOR(FracNet_mul_mul_1ocq):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
