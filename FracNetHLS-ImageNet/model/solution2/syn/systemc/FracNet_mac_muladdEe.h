...
// ==============================================================
#ifndef __FracNet_mac_muladdEe__HH__
#define __FracNet_mac_muladdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladdEe) {
    ...
    SC_CTOR(FracNet_mac_muladdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
