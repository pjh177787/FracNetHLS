...
// ==============================================================
#ifndef __FracNet_mac_muladqcK__HH__
#define __FracNet_mac_muladqcK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladqcK) {
    ...
    SC_CTOR(FracNet_mac_muladqcK):  simcore_mac_6_U ("simcore_mac_6_U") {
