...
// ==============================================================
#ifndef __FracNet_mul_mul_1pcA__HH__
#define __FracNet_mul_mul_1pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1pcA) {
    ...
    SC_CTOR(FracNet_mul_mul_1pcA):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
