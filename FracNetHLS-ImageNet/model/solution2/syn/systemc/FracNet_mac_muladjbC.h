...
// ==============================================================
#ifndef __FracNet_mac_muladjbC__HH__
#define __FracNet_mac_muladjbC__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladjbC) {
    ...
    SC_CTOR(FracNet_mac_muladjbC):  simcore_mac_3_U ("simcore_mac_3_U") {
