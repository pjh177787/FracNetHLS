...
struct load_buf_from_DDR : public sc_module {
    ...
    sc_signal< sc_lv<1> > empty_44_reg_1368;
    ...
    sc_signal< sc_lv<4> > w_fu_859_p2;
    sc_signal< sc_lv<4> > w_reg_1358;
    sc_signal< sc_lv<28> > add_ln96_1_fu_886_p2;
    sc_signal< sc_lv<28> > add_ln96_1_reg_1363;
    sc_signal< sc_lv<1> > empty_44_fu_891_p2;
    sc_signal< sc_lv<4> > select_ln93_1_fu_913_p3;
    sc_signal< sc_lv<4> > select_ln93_1_reg_1378;
    sc_signal< sc_lv<9> > trunc_ln647_fu_920_p1;
    sc_signal< sc_lv<9> > trunc_ln647_reg_1385;
    sc_signal< sc_lv<9> > p_Result_1_reg_1390;
    sc_signal< sc_lv<9> > p_Result_2_reg_1395;
    sc_signal< sc_lv<9> > p_Result_3_reg_1400;
    sc_signal< sc_lv<9> > p_Result_4_reg_1405;
    sc_signal< sc_lv<9> > p_Result_5_reg_1410;
    sc_signal< sc_lv<9> > p_Result_6_reg_1415;
    sc_signal< sc_lv<9> > p_Result_7_reg_1420;
    sc_signal< sc_lv<9> > p_Result_8_reg_1425;
    sc_signal< sc_lv<9> > p_Result_9_reg_1430;
    sc_signal< sc_lv<9> > p_Result_s_reg_1435;
    sc_signal< sc_lv<9> > p_Result_10_reg_1440;
    sc_signal< sc_lv<9> > p_Result_11_reg_1445;
    sc_signal< sc_lv<9> > p_Result_12_reg_1450;
    sc_signal< sc_lv<9> > p_Result_13_reg_1455;
    sc_signal< sc_lv<9> > p_Result_14_reg_1460;
    sc_signal< sc_lv<9> > p_Result_15_reg_1465;
    sc_signal< sc_lv<9> > p_Result_16_reg_1470;
    sc_signal< sc_lv<9> > p_Result_17_reg_1475;
    sc_signal< sc_lv<9> > p_Result_18_reg_1480;
    sc_signal< sc_lv<9> > p_Result_19_reg_1485;
    sc_signal< sc_lv<9> > p_Result_20_reg_1490;
    sc_signal< sc_lv<9> > p_Result_21_reg_1495;
    sc_signal< sc_lv<9> > p_Result_22_reg_1500;
    sc_signal< sc_lv<9> > p_Result_23_reg_1505;
    sc_signal< sc_lv<9> > p_Result_24_reg_1510;
    sc_signal< sc_lv<9> > p_Result_25_reg_1515;
    sc_signal< sc_lv<9> > p_Result_26_reg_1520;
    sc_signal< sc_lv<9> > p_Result_27_reg_1525;
    sc_signal< sc_lv<9> > p_Result_28_reg_1530;
    sc_signal< sc_lv<9> > p_Result_29_reg_1535;
    sc_signal< sc_lv<9> > p_Result_30_reg_1540;
    ...
    sc_signal< sc_lv<11> > zext_ln93_1_fu_865_p1;
    sc_signal< sc_lv<11> > add_ln93_fu_868_p2;
    sc_signal< sc_lv<20> > sext_ln93_1_fu_873_p1;
    ...
    void thread_add_ln93_fu_868_p2();
    ...
    void thread_sext_ln93_1_fu_873_p1();
    ...
    void thread_zext_ln93_1_fu_865_p1();
