...
// ==============================================================
#ifndef __FracNet_mul_mul_8fYi__HH__
#define __FracNet_mul_mul_8fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_8fYi) {
    ...
    SC_CTOR(FracNet_mul_mul_8fYi):  ACMP_smul_us_U ("ACMP_smul_us_U") {
