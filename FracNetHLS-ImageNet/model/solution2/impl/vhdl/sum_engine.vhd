...
architecture behav of sum_engine is 
    ...
    signal t8_V_read_reg_154 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal add6_V_fu_136_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add6_V_reg_159 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal lhs_V_3_fu_116_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal rhs_V_4_fu_120_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln68_1_fu_130_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal add_ln68_fu_124_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal lhs_V_4_fu_142_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal rhs_V_5_fu_145_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal ret_V_fu_148_p2 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add6_V_reg_159 <= add6_V_fu_136_p2;
                t8_V_read_reg_154 <= t8_V;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_ce_reg)) then
                ap_return_int_reg <= ret_V_fu_148_p2;
            end if;
        end if;
    end process;
    ...
    add_ln68_1_fu_130_p2 <= std_logic_vector(signed(lhs_V_3_fu_116_p1) + signed(rhs_V_4_fu_120_p1));
    ...
    ap_return_assign_proc : process(ret_V_fu_148_p2, ap_ce_reg, ap_return_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return <= ap_return_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return <= ret_V_fu_148_p2;
        end if; 
    end process;

        lhs_V_3_fu_116_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add2_V_fu_96_p2),7));

        lhs_V_4_fu_142_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add6_V_reg_159),8));

        lhs_V_fu_108_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add0_V_fu_84_p2),7));

    ret_V_fu_148_p2 <= std_logic_vector(signed(lhs_V_4_fu_142_p1) + signed(rhs_V_5_fu_145_p1));
        rhs_V_4_fu_120_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(add3_V_fu_102_p2),7));

    rhs_V_5_fu_145_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(t8_V_read_reg_154),8));
