...
typedef ap_fixed<18, 10, AP_RND, AP_SAT> FIX_FM_acc; //fix point for accumulation (16, 8)
typedef ap_fixed<16, 6, AP_RND, AP_SAT> FIX_WT; //fix point for weights (14, 5)
...
typedef ap_fixed<14, 4, AP_RND, AP_SAT> FIX_14_4;
//typedef ap_fixed<16, 10, AP_RND, AP_SAT> FIX_16_10;
//typedef ap_fixed<32, 8, AP_RND, AP_SAT> FIX_32_8;
