...
entity compute_engine_32bkb_rom is 
    generic(
             DWIDTH     : integer := 3; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of compute_engine_32bkb_rom is 
...
entity compute_engine_32bkb is
    generic (
        DataWidth : INTEGER := 3;
...
architecture arch of compute_engine_32bkb is
    component compute_engine_32bkb_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    compute_engine_32bkb_rom_U :  component compute_engine_32bkb_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
