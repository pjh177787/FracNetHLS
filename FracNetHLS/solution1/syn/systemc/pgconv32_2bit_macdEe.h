...
// ==============================================================
#ifndef __pgconv32_2bit_macdEe__HH__
#define __pgconv32_2bit_macdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(pgconv32_2bit_macdEe) {
    ...
    SC_CTOR(pgconv32_2bit_macdEe):  simcore_mac_0_U ("simcore_mac_0_U") {
