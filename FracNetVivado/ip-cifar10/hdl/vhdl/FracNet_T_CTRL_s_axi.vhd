...
entity FracNet_T_CTRL_s_axi is
generic (
...
end entity FracNet_T_CTRL_s_axi;
...
architecture behave of FracNet_T_CTRL_s_axi is
    ...
    constant ADDR_IMAGE_V_DATA_0  : INTEGER := 16#10#;
    constant ADDR_IMAGE_V_CTRL    : INTEGER := 16#14#;
