...
//	if (conv3x3_ptr == 3907584) {
//		for (int ch = 0; ch < 32; ch ++){
//			float hw_w = weight3x3_flip[512*32*3 + 12*32*32 + ch][0][0];
//			float sw_w = weight3x3[96][32*12 + ch][0][0];
//			cout << "CH #" << ch << " HW_W= " << hw_w << ",  SW_W= " << sw_w << endl;
//		}
//		cout << "STOP HERE!!" << endl;
//	}
...
//	if (conv3x3_ptr == 3907584) {
//		uint32 hw_w = conv3x3_all_hw_new_3d[conv3x3_ptr/9/512 + 96 + 32*32*14/512][0][0].range(31, 0);
//		for (int ch = 0; ch < 32; ch ++){
//			int hw_wb = hw_w[ch];
//			int sw_w = 0;
//			if (weight3x3[96][32*14 + ch][0][0] > 0) {
//				sw_w = 1;
//			} else {
//				sw_w = 0;
//			}
//			cout << "CH #" << ch << " HW_W= " << hw_wb << ",  SW_W= " << sw_w << endl;
//		}
//		cout << "STOP HERE!!" << endl;
//	}
...
//	cout << "LAYER 2" << endl;
	...
	// layer 7
	cout << "LAYER 7 ptr0 " << ptr[0] << endl;
	cout << "LAYER 7 ptr1 " << ptr[1] << endl;
	...
	// layer 8
	cout << "LAYER 8 ptr0 " << ptr[0] << endl;
	cout << "LAYER 8 ptr1 " << ptr[1] << endl;
	...
	// layer 9
	cout << "LAYER 9 ptr0 " << ptr[0] << endl;
	cout << "LAYER 9 ptr1 " << ptr[1] << endl;
	...
	//	std::ofstream ofs_param0("conv3x3_weights_host.bin", std::ios::out | std::ios::binary);
	//	ofs_param0.write((char*)(conv3x3_all_hw_new), 49104*sizeof(uint512));
	//	ofs_param0.close();
	//	std::ofstream ofs_param1("conv1x1_weights_host.bin", std::ios::out | std::ios::binary);
	//	ofs_param1.write((char*)(conv1x1_all_hw_new), 6132*sizeof(uint512));
	//	ofs_param1.close();
	//	std::ofstream ofs_param2("other_weights_host.bin", std::ios::out | std::ios::binary);
	//	ofs_param2.write((char*)(weights_all_hw), 2730*sizeof(uint512));
	//	ofs_param2.close();
	...
	fwrite(weights_all_hw, sizeof(uint512), 5460, pFile2);
	fclose(pFile2);
