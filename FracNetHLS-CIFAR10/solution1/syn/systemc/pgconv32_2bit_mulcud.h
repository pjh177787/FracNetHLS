...
// ==============================================================
#ifndef __pgconv32_2bit_mulcud__HH__
#define __pgconv32_2bit_mulcud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(pgconv32_2bit_mulcud) {
    ...
    SC_CTOR(pgconv32_2bit_mulcud):  ACMP_smul_us_U ("ACMP_smul_us_U") {
