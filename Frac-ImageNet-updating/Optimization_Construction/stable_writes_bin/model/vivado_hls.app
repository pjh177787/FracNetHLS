...
<project xmlns="com.autoesl.autopilot.project" name="model" top="FracNet" includeRunResult="true">
  <files>
    ...
    <file name="../../array_def.h" sc="0" tb="1" cflags=" -Wno-unknown-pragmas"/>
    ...
    <file name="../../layer_outputs" sc="0" tb="1" cflags=" -Wno-unknown-pragmas"/>
  </files>
  <solutions>
