...
// ==============================================================
#ifndef __FracNet_mul_7ns_3rcU__HH__
#define __FracNet_mul_7ns_3rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_7ns_3rcU) {
    ...
    SC_CTOR(FracNet_mul_7ns_3rcU):  ACMP_mul_us_U ("ACMP_mul_us_U") {
