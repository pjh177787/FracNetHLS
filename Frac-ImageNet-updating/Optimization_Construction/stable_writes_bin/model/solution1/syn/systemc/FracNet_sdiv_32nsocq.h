...
// ==============================================================
#ifndef __FracNet_sdiv_32nsocq__HH__
#define __FracNet_sdiv_32nsocq__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_sdiv_32nsocq) {
    ...
    SC_CTOR(FracNet_sdiv_32nsocq):  ACMP_sdiv_seq_U ("ACMP_sdiv_seq_U") {
