...
// ==============================================================
#ifndef __FracNet_mul_mul_1yd2__HH__
#define __FracNet_mul_mul_1yd2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1yd2) {
    ...
    SC_CTOR(FracNet_mul_mul_1yd2):  ACMP_smul_us_U ("ACMP_smul_us_U") {
