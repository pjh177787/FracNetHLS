...
// ==============================================================
#ifndef __FracNet_mul_29s_9lbW__HH__
#define __FracNet_mul_29s_9lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_29s_9lbW) {
    ...
    SC_CTOR(FracNet_mul_29s_9lbW):  ACMP_mul_su_U ("ACMP_mul_su_U") {
