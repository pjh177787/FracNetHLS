...
// ==============================================================
#ifndef __FracNet_mul_9ns_3hbi__HH__
#define __FracNet_mul_9ns_3hbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_9ns_3hbi) {
    ...
    SC_CTOR(FracNet_mul_9ns_3hbi):  ACMP_mul_us_U ("ACMP_mul_us_U") {
