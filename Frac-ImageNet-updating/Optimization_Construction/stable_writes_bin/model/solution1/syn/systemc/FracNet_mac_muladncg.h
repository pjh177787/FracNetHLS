...
// ==============================================================
#ifndef __FracNet_mac_muladncg__HH__
#define __FracNet_mac_muladncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladncg) {
    ...
    SC_CTOR(FracNet_mac_muladncg):  simcore_mac_4_U ("simcore_mac_4_U") {
