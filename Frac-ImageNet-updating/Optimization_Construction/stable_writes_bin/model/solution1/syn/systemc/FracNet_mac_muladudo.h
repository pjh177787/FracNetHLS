...
// ==============================================================
#ifndef __FracNet_mac_muladudo__HH__
#define __FracNet_mac_muladudo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladudo) {
    ...
    SC_CTOR(FracNet_mac_muladudo):  simcore_mac_6_U ("simcore_mac_6_U") {
