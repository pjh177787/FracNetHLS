...
// ==============================================================
#ifndef __FracNet_mac_muladvdy__HH__
#define __FracNet_mac_muladvdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladvdy) {
    ...
    SC_CTOR(FracNet_mac_muladvdy):  simcore_mac_7_U ("simcore_mac_7_U") {
