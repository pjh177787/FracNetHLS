...
// ==============================================================
#ifndef __FracNet_mac_muladwdI__HH__
#define __FracNet_mac_muladwdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladwdI) {
    ...
    SC_CTOR(FracNet_mac_muladwdI):  simcore_mac_8_U ("simcore_mac_8_U") {
