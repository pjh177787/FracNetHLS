...
// ==============================================================
#ifndef __FracNet_mac_muladfYi__HH__
#define __FracNet_mac_muladfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladfYi) {
    ...
    SC_CTOR(FracNet_mac_muladfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
