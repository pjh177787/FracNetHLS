...
// ==============================================================
#ifndef __FracNet_ama_addmuAem__HH__
#define __FracNet_ama_addmuAem__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_ama_addmuAem) {
    ...
    SC_CTOR(FracNet_ama_addmuAem):  simcore_ama_0_U ("simcore_ama_0_U") {
