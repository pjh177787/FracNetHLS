...
// ==============================================================
#ifndef __FracNet_mac_muladzec__HH__
#define __FracNet_mac_muladzec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladzec) {
    ...
    SC_CTOR(FracNet_mac_muladzec):  simcore_mac_9_U ("simcore_mac_9_U") {
