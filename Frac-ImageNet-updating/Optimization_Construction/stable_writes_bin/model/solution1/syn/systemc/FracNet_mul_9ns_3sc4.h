...
// ==============================================================
#ifndef __FracNet_mul_9ns_3sc4__HH__
#define __FracNet_mul_9ns_3sc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_9ns_3sc4) {
    ...
    SC_CTOR(FracNet_mul_9ns_3sc4):  ACMP_mul_us_U ("ACMP_mul_us_U") {
