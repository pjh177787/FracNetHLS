...
// ==============================================================
#ifndef __FracNet_mul_mul_1xdS__HH__
#define __FracNet_mul_mul_1xdS__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1xdS) {
    ...
    SC_CTOR(FracNet_mul_mul_1xdS):  ACMP_smul_us_U ("ACMP_smul_us_U") {
