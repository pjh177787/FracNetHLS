...
// ==============================================================
#ifndef __FracNet_mac_muladtde__HH__
#define __FracNet_mac_muladtde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladtde) {
    ...
    SC_CTOR(FracNet_mac_muladtde):  simcore_mac_5_U ("simcore_mac_5_U") {
