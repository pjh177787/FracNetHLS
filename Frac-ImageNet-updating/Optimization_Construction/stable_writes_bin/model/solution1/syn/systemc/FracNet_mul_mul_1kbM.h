...
// ==============================================================
#ifndef __FracNet_mul_mul_1kbM__HH__
#define __FracNet_mul_mul_1kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_mul_1kbM) {
    ...
    SC_CTOR(FracNet_mul_mul_1kbM):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
