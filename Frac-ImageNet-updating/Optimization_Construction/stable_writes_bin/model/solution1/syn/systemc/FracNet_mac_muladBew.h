...
// ==============================================================
#ifndef __FracNet_mac_muladBew__HH__
#define __FracNet_mac_muladBew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mac_muladBew) {
    ...
    SC_CTOR(FracNet_mac_muladBew):  simcore_mac_10_U ("simcore_mac_10_U") {
