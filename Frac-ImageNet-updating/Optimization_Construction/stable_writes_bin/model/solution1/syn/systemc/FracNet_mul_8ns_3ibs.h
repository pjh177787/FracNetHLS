...
// ==============================================================
#ifndef __FracNet_mul_8ns_3ibs__HH__
#define __FracNet_mul_8ns_3ibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_8ns_3ibs) {
    ...
    SC_CTOR(FracNet_mul_8ns_3ibs):  ACMP_mul_us_U ("ACMP_mul_us_U") {
