...
// ==============================================================
#ifndef __FracNet_mul_9ns_3mb6__HH__
#define __FracNet_mul_9ns_3mb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_9ns_3mb6) {
    ...
    SC_CTOR(FracNet_mul_9ns_3mb6):  ACMP_mul_us_U ("ACMP_mul_us_U") {
