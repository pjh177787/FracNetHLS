...
// ==============================================================
#ifndef __FracNet_mul_32s_8qcK__HH__
#define __FracNet_mul_32s_8qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(FracNet_mul_32s_8qcK) {
    ...
    SC_CTOR(FracNet_mul_32s_8qcK):  ACMP_mul_su_U ("ACMP_mul_su_U") {
