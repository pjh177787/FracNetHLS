set moduleName load_layer_1D_weight_1
set isTopModule 0
...
set C_modelName {load_layer_1D_weight.1}
...
set C_modelArgMapList {[ 
	{ "Name" : "weights_all_V", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "c_out_offset", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ c_out_offset sc_in sc_lv 6 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "c_out_offset", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "c_out_offset", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	c_out_offset { ap_none {  { c_out_offset in_data 0 6 } } }
