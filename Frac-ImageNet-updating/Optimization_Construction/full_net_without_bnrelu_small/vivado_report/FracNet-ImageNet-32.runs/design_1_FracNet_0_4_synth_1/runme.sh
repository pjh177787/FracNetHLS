...
HD_PWD='C:/Users/Aperture/Git/FracNetVivado/FracNet-ImageNet-32/FracNet-ImageNet-32.runs/design_1_FracNet_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_FracNet_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_FracNet_0_4.tcl
