...
typedef ap_fixed<16, 9, AP_RND, AP_SAT> FIX_FM_acc; //fix point for accumulation (16, 8)
typedef ap_fixed<16, 5, AP_RND, AP_SAT> FIX_WT; //fix point for weights (16, 4)
...
typedef ap_fixed<16, 10, AP_RND, AP_SAT> FIX_16_10;
typedef ap_fixed<32, 8, AP_RND, AP_SAT> FIX_32_8;
typedef ap_fixed<16, 5, AP_RND, AP_SAT> FIX_1D_PACK;
typedef ap_fixed<16, 4, AP_RND, AP_SAT> FIX_DDR;
typedef ap_fixed<24, 16, AP_RND, AP_SAT> FIX_LINR;
//typedef ap_fixed<20, 12, AP_RND, AP_SAT> FIX_20_12;
// typedef ap_fixed<32, 8, AP_RND, AP_SAT> FIX_WT_TEST;
