...
inline int load_1D_weights(
		...
		FIX_WT_TEST weight_buffer[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		int out_channels,
		int weights_all_ptr)
{
...
void bn_relu_sc_relu(
		FIX_WT_TEST conv_threshold[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST conv_bn_weight[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST conv_bn_bias[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST relu_shift_x[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST relu_shift_y[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST relu_weight[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST bn_weight[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
		FIX_WT_TEST bn_bias[1024/OUT_CHANNEL_PARALLELISM][OUT_CHANNEL_PARALLELISM],
...
#pragma HLS PIPELINE
				...
				if (switch_bank == 1) {
					...
					fmap_ptr = c_out*(H_fmap_out/stride+2)*(H_fmap_out/stride+1) + (row_tile_start/stride+row+1)*(H_fmap_out/stride+1) + col;
				}
