...
#pragma HLS PIPELINE
					...
					FIX_FM_acc result_bn = bn1_weight[0][ch]*output + bn1_bias[0][ch];

					FIX_DDR tmp = result_bn;
					DDR_buf_pack[0][row_tile_start/stride + row][col].range(ch*16+15, ch*16) = tmp.range(15, 0);
