...
int main()
{
	...
	for (int k = 0; k < NUM_TESTS; k ++) {
		...
		load_layer_output("layer_outputs/layer3_shiftbn2_output", arr_layer_output);
		cout << "--------- layer3_shiftbn2_output ---------" << endl;
		int ch = 0;
...
//		cout << "---------- SW L2 above ------------" << endl;
		for (int row = 0; row < 28; row ++) {
			for (int col = 0; col < 28; col ++) {
				cout << layer_3_pointwise_0_output[ch][row][col] << "  ";
			}
			cout << endl;
		}
		cout << "---------- SW L3 above ------------" << endl;
