...
architecture behav of load_conv1x1_weights is 
    ...
    signal icmp_ln240_reg_1471 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln242_1_fu_652_p2 : STD_LOGIC_VECTOR (26 downto 0);
    signal add_ln242_1_reg_1460 : STD_LOGIC_VECTOR (26 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal icmp_ln240_fu_668_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state10_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state12_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln240_reg_1471_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal zext_ln242_3_fu_658_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp10_fu_619_p3 : STD_LOGIC_VECTOR (11 downto 0);
    signal trunc_ln242_fu_630_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp38_cast_fu_626_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln242_fu_634_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal add_ln242_fu_638_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal zext_ln242_2_fu_648_p1 : STD_LOGIC_VECTOR (26 downto 0);
    signal zext_ln242_1_fu_644_p1 : STD_LOGIC_VECTOR (26 downto 0);
...
begin
    FracNet_mac_muladbkb_U1364 : component FracNet_mac_muladbkb
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 6,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln240_fu_668_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln240_fu_668_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln240_reg_1471 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln240_reg_1471_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, m_axi_conv_weight_1x1_all_V_ARREADY, ap_CS_fsm_state3, ap_enable_reg_pp0_iter1, icmp_ln240_fu_668_p2, ap_enable_reg_pp0_iter0, ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_subdone)
    begin
        case ap_CS_fsm is
    ...
    add_ln242_1_fu_652_p2 <= std_logic_vector(unsigned(zext_ln242_2_fu_648_p1) + unsigned(zext_ln242_1_fu_644_p1));
    add_ln242_fu_638_p2 <= std_logic_vector(unsigned(tmp38_cast_fu_626_p1) + unsigned(zext_ln242_fu_634_p1));
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_conv_weight_1x1_all_V_RVALID, ap_enable_reg_pp0_iter1, icmp_ln240_reg_1471)
    begin
                ap_block_pp0_stage0_11001 <= ((icmp_ln240_reg_1471 = ap_const_lv1_0) and (m_axi_conv_weight_1x1_all_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_conv_weight_1x1_all_V_RVALID, ap_enable_reg_pp0_iter1, icmp_ln240_reg_1471)
    begin
                ap_block_pp0_stage0_subdone <= ((icmp_ln240_reg_1471 = ap_const_lv1_0) and (m_axi_conv_weight_1x1_all_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;

        ap_block_state10_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state11_pp0_stage0_iter1_assign_proc : process(m_axi_conv_weight_1x1_all_V_RVALID, icmp_ln240_reg_1471)
    begin
                ap_block_state11_pp0_stage0_iter1 <= ((icmp_ln240_reg_1471 = ap_const_lv1_0) and (m_axi_conv_weight_1x1_all_V_RVALID = ap_const_logic_0));
    end process;

        ap_block_state12_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state10_assign_proc : process(icmp_ln240_fu_668_p2)
    begin
        if ((icmp_ln240_fu_668_p2 = ap_const_lv1_1)) then 
    ...
    conv_weight_1x1_all_V_blk_n_R_assign_proc : process(m_axi_conv_weight_1x1_all_V_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln240_reg_1471)
    begin
        if (((icmp_ln240_reg_1471 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    icmp_ln240_fu_668_p2 <= "1" when (i_0_reg_596 = ap_const_lv2_2) else "0";
    ...
    m_axi_conv_weight_1x1_all_V_ARADDR <= zext_ln242_3_fu_658_p1(32 - 1 downto 0);
    ...
    m_axi_conv_weight_1x1_all_V_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln240_reg_1471, ap_block_pp0_stage0_11001)
    begin
        if (((icmp_ln240_reg_1471 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    tmp10_fu_619_p3 <= (tmp_reg_1455 & ap_const_lv1_0);
    tmp38_cast_fu_626_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp10_fu_619_p3),13));
    trunc_ln242_fu_630_p1 <= conv1x1_weight_ptr(12 - 1 downto 0);
    trunc_ln414_fu_680_p1 <= i_0_reg_596(1 - 1 downto 0);
    trunc_ln647_fu_684_p1 <= m_axi_conv_weight_1x1_all_V_RDATA(32 - 1 downto 0);
    zext_ln242_1_fu_644_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln242_fu_638_p2),27));
    zext_ln242_2_fu_648_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(conv_weight_1x1_all_V_offset),27));
    zext_ln242_3_fu_658_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(add_ln242_1_reg_1460),64));
    zext_ln242_fu_634_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(trunc_ln242_fu_630_p1),13));
end behav;
