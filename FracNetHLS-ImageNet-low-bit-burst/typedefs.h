...
typedef ap_fixed<8, 5, AP_RND, AP_SAT> FIX_FM_acc; //fix point for accumulation (16, 8)
typedef ap_fixed<12, 5, AP_RND, AP_SAT> FIX_WT; //fix point for weights (16, 4)
...
typedef ap_fixed<4, 2, AP_RND, AP_SAT> FIX_DDR;
typedef ap_int<8> FIX_BUF_ALL;
