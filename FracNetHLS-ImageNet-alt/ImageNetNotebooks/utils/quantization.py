...
class BinaryConv2d(nn.Conv2d):
    ...
    def forward(self, input):
        x = F.conv2d(input, self.binarize(self.weight),
...
class PGBinaryConv2d(nn.Conv2d):
    ...
    def forward(self, input):
        ...
        # print(self.truncate_a(input))
        # print('binarized weights')
        # print(self.binarize(self.weight))
        ...
        # print(out_msb)
        # print("sigmoid")
        # print(torch.sigmoid(5.0*(out_msb-self.threshold)))
        ...
        out_full = F.conv2d(input,
                           ...
                           self.dilation, self.groups)
        ''' combine outputs '''
        x = (1-mask) * out_msb + mask * out_full
        # print('pgconv')
        # print(x)
        return x
