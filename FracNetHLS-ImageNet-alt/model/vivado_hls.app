...
<project xmlns="com.autoesl.autopilot.project" name="model" top="FracNet">
  <files>
    ...
    <file name="weights_conv1_64.h" sc="0" tb="false" cflags="" blackbox="false"/>
  ...
  <libraryFlag/>
  <Simulation argv="">
    <SimFlow name="csim" optimizeCompile="true" ldflags="-Wl,--stack,10485760" mflags="" clean="true" csimMode="0" lastCsimMode="0"/>
  </Simulation>
</project>
